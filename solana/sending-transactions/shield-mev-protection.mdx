---
title: "Shield MEV protection"
description: "Yellowstone Shield lets you control which validators can process your Solana transactions via on-chain allowlists or blocklists. Anti-sandwich, anti-frontrunning, anti-MEV at the routing layer."
---

import FooterLinks from '/snippets/footer-links.mdx'
import JetCard from '/snippets/cards/jet-sender.mdx'
...
Yellowstone Shield lets you control which validators can process your Solana transactions. Simple but powerful idea: create a list of validators you trust (allowlist) or don't trust (blocklist), and your transactions only go to validators that match your criteria.
...
<Note>
  Shield only works with Shield-enabled RPCs (like those using [Yellowstone Jet](/solana/sending-transactions/jet-sender)). Standard Solana RPCs ignore the policy parameter.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Yellowstone Shield blog post" icon="book-open" href="https://blog.triton.one/introducing-yellowstone-shield">
    The full architecture and design rationale behind Shield.
  </Card>
</CardGroup>
