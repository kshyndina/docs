---
title: "Accounts"
description: "Manage Triton organisation members programmatically: list, invite, change role, remove."
keywords: ["triton members api", "invite member api", "rbac api", "organisation members"]
---
...
<ParamField path="role" type="string" required>
  One of `owner`, `admin`, `viewer`. See [Set up your account](/solana/get-started/account-management/set-up-your-account-and-add-users#roles) for capabilities.
</ParamField>
