---
title: "Tokens"
description: "Issue, rotate, and revoke per-endpoint authentication tokens for Triton Solana RPC."
keywords: ["rpc token api", "rotate token", "revoke token", "token api"]
---
...
<Columns cols={2}>
  <Card title="Auth and security" icon="shield" href="/solana/get-started/account-management/auth-and-security-best-practices">
    The conceptual playbook for token hygiene.
  </Card>
