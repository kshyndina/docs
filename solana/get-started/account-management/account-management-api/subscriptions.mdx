---
title: "Subscriptions"
description: "List, attach, and detach plan subscriptions on a Triton organisation. Pricing-tier and add-on management."
keywords: ["subscriptions api", "plan attach", "addon", "billing api"]
---

The Subscriptions resource describes which plan and add-ons your organisation has attached. The API is read + minor writes; full plan changes go through the portal or your account manager.
...
[Reach out to support](/solana/get-started/account-management/reach-out-to-support) for plan changes.
...
<Columns cols={2}>
  ...
  <Card title="Plans and billing" icon="credit-card" href="/solana/get-started/plans-and-billing">
    Conceptual overview of pricing.
  </Card>
</Columns>
