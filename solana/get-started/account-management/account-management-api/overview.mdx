...
description: "Programmatically provision Triton endpoints, rotate tokens, manage allowlists, and invite teammates over a REST API."
keywords: ["triton api", "account management api", "provision endpoint", "rotate token api", "allowlist api"]
---
...
<Columns cols={2}>
  <Card title="Auth and headers" icon="key" href="/solana/get-started/account-management/account-management-api/auth-and-headers">
    Bearer tokens, organisation context, common headers.
  </Card>
...
- **Rate tiers** describe the limits on an endpoint (read-only on PAYG; configurable on committed and above).
...
| `5xx` | Server-side; retry with backoff. Persistent 5xx -> [contact support](/solana/get-started/account-management/reach-out-to-support) |

## What's next

<Columns cols={2}>
  <Card title="Auth and headers" icon="key" href="/solana/get-started/account-management/account-management-api/auth-and-headers">
    Token format, headers, organisation switching.
  </Card>
  <Card title="Endpoints" icon="link" href="/solana/get-started/account-management/account-management-api/endpoints">
    Most-used resource: provisioning and configuration.
  </Card>
</Columns>
