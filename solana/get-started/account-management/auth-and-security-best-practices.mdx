...
description: "How Triton authenticates Solana RPC requests, how to rotate tokens safely, and what to do if a token leaks."
keywords: ["triton auth", "rpc token", "bearer", "origin allowlist", "token rotation", "leaked api key"]
---
