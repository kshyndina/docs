...
<AccordionGroup>
  <Accordion title="Standard JSON-RPC" icon="zap">
    | Method | Default limit per 10s |
    |---|---|
    | Total RPS per IP | 2,000 |
  ...
  <Accordion title="Streaming services (gRPC)" icon="radio">
