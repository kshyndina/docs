...
Solana has no public mempool. Transactions forward through your RPC straight into the current slot leader's TPU pipeline, so where your RPC sits and how it's connected affects your landing rate, your fill prices, and how fresh the data your indexer reads is.
...
- **We're a Solana validator since testnet** and we author the streaming layer the network runs on, Yellowstone gRPC.
...
<div className="stack-map not-prose">
  ...
  <div className="stack-pillars">
    ...
    <div className="stack-pillar stack-pillar-dedicated">
      <div className="stack-pillar-title">Dedicated gRPC node</div>
    ...
    <div className="stack-pillar stack-pillar-validator">
      <div className="stack-pillar-title">Validator services</div>
      <div className="stack-branches stack-branches-single">
        <div className="stack-branch">
