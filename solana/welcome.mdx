...
| Network | HTTPS<br />RPC | Web<br />Sockets | Yellowstone<br />gRPC | Fumarole | Steamboat<br />indexed | Historical<br />archive |
| --- | :-: | :-: | :-: | :-: | :-: | :-: |
| Solana mainnet | ✓ | ✓ | ✓ | ✓ | v1 only | ✓ |
...
<CardGroup cols={2}>
  <Card title="Set up your account" icon="user-plus" href="/solana/get-started/account-management/platform-overview">
