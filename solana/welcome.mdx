...
<div className="logo-marquee not-prose">
  <div className="logo-marquee-track logo-track-left">
    ...
    <img src="/logos/raydium.svg" alt="" className="logo-grow" />
...
<div className="triton-try not-prose" data-triton-try>
  ...
  <div className="triton-try-body">
    <div className="triton-try-code" data-code>curl https://api.mainnet.solana.com -X POST -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","id":1,"method":"getSlot"}'</div>
    ...
    <div className="stack-pillar stack-pillar-shared">
      ...
      <div className="stack-branches">
        ...
        <div className="stack-branch">
          ...
          <a className="stack-leaf" href="/solana/streaming/steamboat/overview">Account indexes (gPA)</a>
          ...
          <a className="stack-leaf" href="/solana/reading-state/account-sync">Accounts-sync</a>
        </div>

        <div className="stack-branch">
          <div className="stack-branch-title">Streaming</div>
          <a className="stack-leaf" href="/solana/streaming/dragons-mouth/overview">Yellowstone gRPC</a>
          <a className="stack-leaf" href="/solana/streaming/whirligig/overview">Improved WebSockets</a>
          <a className="stack-leaf" href="/solana/streaming/fumarole/overview">Persistent streams</a>
          <a className="stack-leaf" href="/solana/streaming/hermes/overview">Pyth price feeds</a>
        ...
        <div className="stack-branch">
          ...
          <a className="stack-leaf" href="/solana/history/old-faithful/overview">Open Solana archive</a>
          <a className="stack-leaf" href="/solana/history/faithful-streams/overview">Historical gRPC streams</a>
        </div>
        ...
        <div className="stack-branch">
          ...
          <a className="stack-leaf" href="/solana/trading-apis/metis/overview">Metis API</a>
          <a className="stack-leaf" href="/solana/trading-apis/titan-prime/overview">Titan Prime API</a>
...
<CardGroup cols={3}>
  ...
  <Card title="Build a wallet with Triton" icon="image" href="/solana/digital-assets/das-api/overview">
    DAS API for NFTs, cNFTs, SPL, Token-2022 assets.
  </Card>

  <Card title="Set up the Titan Swap API" icon="route" href="/solana/trading-apis/titan-prime/overview">
    DART live re-optimisation, streaming swaps for trading apps.
  </Card>

  <Card title="Connect price feeds" icon="activity" href="/solana/streaming/hermes/overview">
    Hermes Pyth feed API. REST plus WebSocket; powers Pyth JS SDK.
  </Card>
</CardGroup>
