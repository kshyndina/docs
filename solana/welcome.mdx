...
|---|:---:|:---:|:---:|:---:|
| Solana mainnet | yes | yes | yes (dedicated) | yes (Hydrant + Old Faithful) |
| Solana devnet | yes | yes | yes (dedicated) | not available |

Both networks served from 20+ global regions via GeoDNS. Devnet for testing, mainnet for production.
