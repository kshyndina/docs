...
import DmSubSlotLatencyCard from '/snippets/cards/features/dm-sub-slot-latency.mdx'
import DmServerFilteringCard from '/snippets/cards/features/dm-server-filtering.mdx'
import DmBidirectionalStreamsCard from '/snippets/cards/features/dm-bidirectional-streams.mdx'
import DmCompactProtobufCard from '/snippets/cards/features/dm-compact-protobuf.mdx'
...
<CardGroup cols={2}>
  <DmSubSlotLatencyCard />

  <DmServerFilteringCard />

  <DmBidirectionalStreamsCard />

  <DmCompactProtobufCard />
</CardGroup>
