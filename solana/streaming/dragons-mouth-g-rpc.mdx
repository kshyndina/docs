...
It's the fastest live data path available and the recommended choice for any backend service where latency matters. Stream data directly to your application's middle layer hosted on a cloud provider, and update your backend database with the lowest possible latency.
