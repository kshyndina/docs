...
For browser clients that can't communicate with gRPC, use [Whirligig WebSockets](https://tritonone.mintlify.app/solana/streaming/whirligig-websockets) instead.
