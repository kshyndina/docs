...
All streaming services are billed at `$0.08 / GB` of bandwidth, and you only pay for data sent. See [streaming best practices](/solana/streaming/best-practices) for filtering, guides, and other ways to reduce it.
