...
| Capability | Dragon's Mouth | Deshred tx | Whirligig websocket | Fumarole | Old Faithful | Pyth Hermes |
| --- | :-: | :-: | :-: | :-: | :-: | :-: |
| Real-time data | ✓ |  | ✓ | ✓ |  |  |
...
<CardGroup cols={3}>
  <Card title="Dragon's Mouth gRPC" icon="radio" href="/solana/streaming/dragons-mouth/quickstart">
    Sub-slot account, transaction, slot, and block subscriptions over Yellowstone gRPC.
  </Card>

  <Card title="Whirligig" icon="rotate-cw" href="/solana/streaming/whirligig/quickstart">
    Drop-in for native Solana WebSockets with custom `transactionSubscribe`.
  </Card>

  <Card title="Fumarole" icon="layers" href="/solana/streaming/fumarole/quickstart">
  ...
  <Card title="Hermes" icon="activity" href="/pyth/pyth-hermes">
    Pyth price feed API. REST plus WebSocket. Powers the Pyth JS SDK.
  </Card>
