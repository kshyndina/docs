...
description: "The fastest way to see Solana transactions: reconstruct transactions from validator shreds before the slot finalises."
keywords: ["deshred", "shred reconstruction", "solana shreds", "lowest latency transactions", "mev"]
---
...
Deshred is enabled on dedicated nodes by default and as an add-on on committed plans. Not available on PAYG. [Contact support](/solana/get-started/account-management/reach-out-to-support) to enable.
