...
- Your endpoint URL and secret token from the [customer dashboard](https://customers.triton.one/) ([how to get them](/solana/get-started/account-management/platform-overview))
