...
Test all Triton streaming solutions in 5 minutes. For the streaming overview and product comparison, see the[ overview page](/solana/streaming/overview).
...
4. Keep alive ??? did we include it in code? 
5. **Test reconnection (optional).** Drop your network briefly and confirm your client reconnects and resumes.
