...
<CardGroup cols={2}>
  ...
  <Card title="Intra-slot updates" icon="zap">
  ...
  <Card title="All commitment levels" icon="layers">
...
<CardGroup cols={2}>
  <Card title="Streaming quickstart" icon="zap" href="/solana/streaming/quickstart">
    Get a Whirligig WebSocket stream running in five minutes.
  </Card>

  <Card title="Dragon's Mouth gRPC" icon="radio" href="/solana/streaming/dragons-mouth-g-rpc">
    Lower-latency gRPC version of the same data, for backends.
  </Card>

  <Card title="Fumarole" icon="layers" href="/solana/streaming/fumarole-persistent-streams">
    Persistent gRPC subscribers with deduplication and resume from cursor.
  </Card>

  <Card title="Streaming overview" icon="radio" href="/solana/streaming/overview">
    Compare Whirligig against the rest of the streaming stack.
  </Card>
</CardGroup>
