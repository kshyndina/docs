...
<CardGroup cols={2}>
  <Card title="Solana WebSocket compatible" icon="plug">
    Drop-in replacement for the standard Solana WebSocket API.
  </Card>

  <Card title="Intra-slot updates" icon="gauge">
    Account updates up to 400ms faster than standard WebSockets at `processed`.
  </Card>

  <Card title="transactionSubscribe extension" icon="receipt">
    Triton-only subscription for filtered transaction notifications.
  </Card>

  <Card title="All commitment levels" icon="signal-high">
    Subscribe at `processed`, `confirmed`, or `finalized`.
  </Card>
</CardGroup>
