...
`GET /api/v1/subscriptions/:subscription-uuid`
...
| Name                                                          | Type       | Description                                                                                                                          |
| ------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| account\_uuid \*required      | `string`   | Primary key of the account that the subscription should belong to.                                                                   |
| subscription\_type \*required | `string`   | Name of the subscription type. Obtained from the Subscription Types endpoint.                                                        |
| name \*required               | `string`   | A human readable display name to describe the subscription.                                                                          |
