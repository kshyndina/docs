...
| rate\_tier \*required | `string` | The name of the Rate Tier for this token, which defines rate limits for it. Each token incurs costs based on the Rate Tier defined for it.        |
