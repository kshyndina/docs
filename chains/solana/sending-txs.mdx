---
title: "Transaction sending advice"
description: "Recommendations to optimize transaction delivery through our Cascade network."
hidden: true
---
...
* Set a [**tight Compute Unit (CU) budget** and a **competitive priority fee**](/sending-txs#id-3.-set-precise-compute-budgets-and-priority-fees).&#x20;
</Tip>
...
* **Priority Fee:** Including a priority fee is essential. You should check the prevailing market rates for the accounts your transaction needs to write-lock. Our [Improved Priority Fees API](/improved-priority-fees-api) can help you determine a competitive fee without overpaying.
