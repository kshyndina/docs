...
title: "Proxying"
---
: We Strongly Advise Against Proxying Our platform is engineered for optimal performance, reliability, and security through direct connections. Placing a third-party proxy (like Cloudflare) in front
