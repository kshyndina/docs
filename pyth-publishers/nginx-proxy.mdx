---
title: "NGINX proxy"
description: "For your pythd to communicate with our servers over an encrypted channel, it is recommended that you set up an NGINX proxy. This also allows for token authentication, meaning we do not need to…"
---
...
Source:
[https://github.com/pyth-network/pyth-client/blob/main/doc/example-nginx-triton1.conf](https://github.com/pyth-network/pyth-client/blob/main/doc/example-nginx-triton1.conf)
