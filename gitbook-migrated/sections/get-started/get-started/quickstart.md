...
If you got back something like `{ "jsonrpc": "2.0", "result": 311340987, "id": 1 }`, you're connected. If you hit a 401, 429, timeout, or gRPC 403, see the [Error handling guide](../../solana-guides/error-handling/how-to-troubleshoot.md) for the full debug flow.
{% endstep %}
{% endstepper %}
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><i class="fa-coins">:coins:</i> <strong>Trading or market making</strong></td><td>Live prices, sub-slot tx landing, anti-MEV. Stack: Dragon's Mouth, Jet, Priority Fees, Shield.</td><td><a href="../../solana-guides/quickstart-on-triton/trading-and-market-making.md">../../solana-guides/quickstart-on-triton/trading-and-market-making.md</a></td></tr><tr><td><i class="fa-code-merge">:code-merge:</i> <strong>DeFi protocols (Lending, DEXs)</strong></td><td>Pool state, swap activity, tx landing, historical fills. Stack: Dragon's Mouth, Jet, Hydrant, Titan.</td><td><a href="../../solana-guides/quickstart-on-triton/dex-or-defi-protocol.md">../../solana-guides/quickstart-on-triton/dex-or-defi-protocol.md</a></td></tr><tr><td><i class="fa-mobile-screen">:mobile-screen:</i> <strong>Wallet or consumer app</strong></td><td>Balances, history, NFT portfolio, live updates. Stack: Standard RPC, DAS API, Whirligig.</td><td><a href="../../solana-guides/quickstart-on-triton/wallet-or-consumer-app.md">../../solana-guides/quickstart-on-triton/wallet-or-consumer-app.md</a></td></tr><tr><td><i class="fa-palette">:palette:</i> <strong>NFT marketplace</strong></td><td>Mints, metadata, collection feeds, sale events. Stack: DAS API, ZK Compression, Whirligig.</td><td><a href="../../solana-guides/quickstart-on-triton/nft-or-compressed-asset-platform.md">../../solana-guides/quickstart-on-triton/nft-or-compressed-asset-platform.md</a></td></tr><tr><td><i class="fa-chart-column">:chart-column:</i> <strong>Indexer or analytics</strong></td><td>Custom indexes, historical backfill, parsed transactions. Stack: Steamboat, Hydrant, Old Faithful, Fumarole.</td><td><a href="../../solana-guides/quickstart-on-triton/indexer-or-analytics.md">../../solana-guides/quickstart-on-triton/indexer-or-analytics.md</a></td></tr><tr><td><i class="fa-gamepad">:gamepad:</i> <strong>Gaming</strong></td><td>On-chain item state, real-time updates, fast reads. Stack: Standard RPC, DAS API, Dragon's Mouth, Whirligig.</td><td><a href="../../solana-guides/quickstart-on-triton/gaming.md">../../solana-guides/quickstart-on-triton/gaming.md</a></td></tr><tr><td><i class="fa-robot">:robot:</i> <strong>AI agent or LLM app</strong></td><td>MCP access, llms.txt context, autonomous setup. Stack: MCP, llms.txt, Standard RPC, DAS API.</td><td><a href="../../solana-guides/quickstart-on-triton/ai-agent-or-llm-app.md">../../solana-guides/quickstart-on-triton/ai-agent-or-llm-app.md</a></td></tr></tbody></table>
