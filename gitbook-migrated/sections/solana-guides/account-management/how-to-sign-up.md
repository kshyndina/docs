...
Keep the token server-side. For browser apps, set up an [origin allowlist](https://kate-6.gitbook.io/triton-one-docs/documentation/get-started/authentication) instead of using the token.
{% endstep %}
{% step %}
