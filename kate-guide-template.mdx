...
Triton's [Vixen parsing framework](/solana/reading-state/steamboat-indexed-accounts) covers Jupiter, Raydium, Orca, and Meteora out of the box.
...
<AccordionGroup>
  ...
  <Accordion title="Jet returns 'leader unavailable'">
    Slot rotation, no leader for the next few slots. The Jet client retries automatically; if you see this for >5 seconds, check the [Jet status page](/solana/sending-transactions/jet-sender).
  </Accordion>
</AccordionGroup>
