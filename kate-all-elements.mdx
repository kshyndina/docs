...
- <Badge color="purple" shape="pill">PRIVATE BETA</Badge> &nbsp; invite-only, not yet open. Maps to brand violet (Triton purple).
- <Badge color="blue" shape="pill">PUBLIC BETA</Badge> &nbsp; open beta, anyone can use. Maps to brand blue (clarity, trustworthiness).
- <Badge color="yellow" shape="pill">COMING SOON</Badge> &nbsp; announced, not yet shipped. Maps to brand gold (anticipation, KPI highlight).
- <Badge color="red" shape="pill">DEPRECATED</Badge> &nbsp; retired or scheduled for retirement. Maps to semantic error red.
