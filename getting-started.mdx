...
description: "To get started with using Triton One you will need access to a customer account with an active subscription."
---
...
To get started with using Triton One you will need access to a customer account with an active subscription. Self sign up: You can sign up following this link and make a deposit to activate your account. Contact us directly: For custom inquiries, you can email us at [email protected] or reach out via Telegram.
...
If you suspect it has been leaked, contact us immediately to have it rotated.
...
You're all set! Now you can explore the rest of our documentation to make the most of our service: Learn about our Core Features like GeoDNS and Rate Limiting. Read our guide on Best Practices for Sending Solana Transactions. Discover our Advanced Data & Streaming services for real-time insights.
