...
| Real-time slot-by-slot account updates | [Dragon's Mouth gRPC](/solana/streaming/dragons-mouth-g-rpc) | Streaming sits in the next section, but it's often the right answer. |
...
<CardGroup cols={2}>
  ...
  <Card title="Historical data" href="/solana/history/hydrant">
