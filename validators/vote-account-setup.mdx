...
description: "NOTE: Should we host your validator, we will set up the vote account for you. The information below is for transparency and educational purposes."
---

NOTE: Should we host your validator, we will set up the vote account for you. The rmation below is for transparency and educational purposes.
...
[![Logo](https://docs.triton.one/~gitbook/image?url=https%3A%2F%2Fdocs.anza.xyz%2Fimg%2Ffavicon.ico&width=20&dpr=3&quality=100&sign=c45de0cf&sv=2)Validator Guide: Vote Account Management | Agavedocs.solana.com](https://docs.solana.com/running-validator/vote-accounts)
