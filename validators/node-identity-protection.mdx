...
description: "The public-private key pair of the node identity enables the node to vote on behalf of your vote account. We hold this key pair and deploy it to the node."
---
