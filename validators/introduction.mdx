...
- Frankendancer – a hybrid validator client maintained by (Jump Crypto)(https://jumpcrypto.com/firedancer/), combining a Firedancer networking and b ingestion stack with consensus execution provided by Agave. It is engineered for high performance and low-latency b processing and is already in production on mainnet with active participation.
