...
If you already have code built for our [gRPC streams in Dragon’s Mouth](/project-yellowstone/dragons-mouth-grpc-subscriptions), integrating with Fumarole for additional reliability is easy. The code changes should be minimal as Fumarole uses the same types as Dragon’s Mouth.
