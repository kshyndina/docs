...
Learn more about Shield in our blog post: [Introducing Yellowstone Shield 🚫🛡️arrow-up-right](https://blog.triton.one/introducing-yellowstone-shield)
...
- Policies only b validators that are on your blocklist (or not on your allowlist)
