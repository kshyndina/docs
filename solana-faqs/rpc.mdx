---
title: "RPC"
description: "Performance, reliability, configuration, and troubleshooting questions for Triton's Solana RPC services."
sidebarTitle: "RPC"
---
...
<AccordionGroup>
  ...
  <Accordion title="Can I run scripts on the shared service?">
    Yes. Our shared infrastructure is designed to handle backend workloads and absorbs traffic well. You can run scripts, bots, and indexers on shared endpoints. If your usage outgrows the shared pool's rate limits, dedicated nodes are the next step.
  </Accordion>
</AccordionGroup>
