---
title: "RPC requests"
description: "Questions about Triton's RPC services, latency, rate limits, dedicated nodes, scripts, monitoring, and Web3.js."
---

import FooterLinks from '/snippets/footer-links.mdx'

Questions about Triton's HTTP RPC service: how it performs, how to configure it, and what to do when something goes wrong.
...
Customers with [dedicated nodes](/solana/dedicated-nodes/overview) get a Grafana dashboard with real-time metrics: request volume, latency, error rates, and bandwidth usage.
  ...
  <Accordion title="Can I create new tokens or endpoints myself?">
    Standard accounts can't create tokens or endpoints directly. If you need self-service provisioning, ask support to upgrade you to the **operator** role. Once enabled, you can add tokens and endpoints from the dashboard without going through support.
  </Accordion>
