...
<AccordionGroup>
  ...
  <Accordion title="What is Project Yellowstone?">
    ...
    For deeper questions about Yellowstone components, see the [Streaming FAQs](/solana-faqs/streaming).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="How can I get started with Triton services? / How do I get an account?">
    The fastest path is to sign up at [customers.triton.one](https://customers.triton.one/users/sign-up), verify your email, and top up the $125 minimum to get a PAYG endpoint. For custom inquiries (dedicated nodes, invoiced billing), email us at [support@triton.one](mailto:support@triton.one) or contact us on [Telegram](https://t.me/tritonone).
  </Accordion>
