...
| --- | --- | --- |
| transactions * | Vector | List of transactions to simulate. |
...
chevron-rightRpcSimulateBundleConfig: Bundle configuration[hashtag](#rpcsimulatebundleconfig-bundle-configuration)
