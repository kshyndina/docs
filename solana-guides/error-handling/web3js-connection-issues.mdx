...
description: "Why high-throughput Solana web3.js apps in NodeJS hit ECONNREFUSED, ECONNRESET, fetch failed, and how to fix it with connection pooling."
sidebarTitle: "Web3JS socket issues"
---
...
<Accordion title="Click to see full error examples">
```text
