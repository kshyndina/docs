---
title: "Verify your gRPC endpoint"
description: "Use Triton's known-good Linux test client to figure out whether a gRPC error is on your endpoint or in your application code."
sidebarTitle: "Verify gRPC endpoint"
---
