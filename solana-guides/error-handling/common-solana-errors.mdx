---
title: "Common Solana errors"
description: "Standard list of common JSON-RPC error codes you may experience, plus uncommon Web3JS errors we have previously helped customers resolve."
sidebarTitle: "Common Solana errors"
---
