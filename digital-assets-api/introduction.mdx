...
DAS API provides a fast and scalable way to query digital assets on the Solana blockchain, including Fungible Tokens, Regular and Compressed NFTs. The decompression of NFTs and data caching is done server-side, providing a convenient way to access Digital Assets data and metadata.
It is available via all our shared and dedicated endpoints, fully integrated with our RPC Pool infrastructure.
...
Available methods are listed and documented in the [API Methods](/digital-assets-api/metaplex-digital-assets-api/metaplex-digital-assets-api) section.
...
[Ratelimits](/../rpc-pool/ratelimits) as per your standard RPC Pool will apply. 
