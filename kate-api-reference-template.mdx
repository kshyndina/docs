...
- For real-time updates, use [`accountSubscribe`](#) over WebSocket or [Dragon's Mouth gRPC](/solana/streaming/dragons-mouth/overview).
...
For 401, 429, timeout, and gRPC-403 patterns, see the [Error handling guide](/solana-guides/error-handling/overview).
...
<CardGroup cols={2}>
  ...
  <Card title="Error handling" href="/solana-guides/error-handling/overview">
