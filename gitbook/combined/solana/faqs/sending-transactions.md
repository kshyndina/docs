...
Triton ensures reliable transaction delivery to the network, but for optimal transaction finalisation, we recommend configuring appropriate priority fees. See our [Priority Fees API](../documentation/sending-transactions/priority-fees-api.md) for how to set them.
