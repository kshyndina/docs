...
<table data-card-size="medium" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><i class="fa-radio">:radio:</i> <strong>Dragon's Mouth</strong></td><td>Subscribe to DEX pool account updates and transactions in real time.</td><td><a href="../../documentation/streaming-data/dragon-s-mouth-grpc.md">../../documentation/streaming-data/dragon-s-mouth-grpc.md</a></td></tr><tr><td><i class="fa-fire">:fire:</i> <strong>Deshred</strong></td><td>Receive transactions \~20 ms before standard gRPC at p90 for earliest signal.</td><td><a href="../../documentation/streaming-data/deshred-transactions.md">../../documentation/streaming-data/deshred-transactions.md</a></td></tr><tr><td><i class="fa-arrow-trend-up">:arrow-trend-up:</i> <strong>Priority Fee API</strong></td><td>Get a percentile-based fee estimate before building your transaction.</td><td><a href="../../documentation/sending-transactions/priority-fees-api.md">../../documentation/sending-transactions/priority-fees-api.md</a></td></tr><tr><td><i class="fa-paper-plane">:paper-plane:</i> <strong>Jet</strong></td><td>Send transactions directly to the current leader with built-in SWQoS.</td><td><a href="../../documentation/sending-transactions/yellowstone-jet.md">../../documentation/sending-transactions/yellowstone-jet.md</a></td></tr><tr><td><i class="fa-shield-halved">:shield-halved:</i> <strong>Shield</strong></td><td>(Optional) Block specific validators from processing your transactions.</td><td><a href="../../documentation/sending-transactions/shield-mev-protection.md">../../documentation/sending-transactions/shield-mev-protection.md</a></td></tr></tbody></table>
## Prerequisites
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><i class="fa-fire">:fire:</i> <strong>Deshred transactions</strong></td><td>Pre-execution transactions reconstructed from raw shreds. Earliest intent signal for traders.</td><td><a href="../../documentation/streaming-data/deshred-transactions.md">../../documentation/streaming-data/deshred-transactions.md</a></td></tr><tr><td><i class="fa-shield-halved">:shield-halved:</i> <strong>Shield MEV protection</strong></td><td>On-chain allowlists or blocklists with local enforcement. No added latency on the send path.</td><td><a href="../../documentation/sending-transactions/shield-mev-protection.md">../../documentation/sending-transactions/shield-mev-protection.md</a></td></tr><tr><td><i class="fa-code-branch">:code-branch:</i> <strong>Metis swap API</strong></td><td>Swap routing across 20+ DEXes with exact-out and platform-fee support built in.</td><td><a href="../../documentation/sending-transactions/metis-swap-api.md">../../documentation/sending-transactions/metis-swap-api.md</a></td></tr><tr><td><i class="fa-route">:route:</i> <strong>Titan swap API</strong></td><td>Streaming quotes and routes via DART live re-optimisation or the Prime API for high-volume desks.</td><td><a href="../../documentation/sending-transactions/titan-swap-api.md">../../documentation/sending-transactions/titan-swap-api.md</a></td></tr></tbody></table>
<hr>
